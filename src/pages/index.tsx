...
const Home = () => {
  ...
  return (
    <>
      <MetaTags
        title="Wander Wise"
        description="Fully-responsive Travel App that gives you real time data about nearby Attractions, Hotels and Restaurants. Used GoogleMaps API, TravelAdvisor API and Weather API. Next.js, TypeScript used in building app."
        url="https://github.com/anveshanayak/Wander-Wise-Travel-Companion"
      />
      ...
      >
        ...
        <DialogContent>
          <DialogContentText id="alert-dialog-description">
            {`The TravelAdvisor API gives only 500 requests per month for free. If this message displays then it means the quota has been reached. It refreshes on the 17th of every month`}
            <br />
            <br />
            {`The Google Map Search functionality and the weather for said location can still be accessed. Apologies for any inconvenience caused.`}
          </DialogContentText>
        </DialogContent>
        <DialogActions>
